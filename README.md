...
The course website uses the [Jekyll] static website generator to render its content. Since the course is highly intergrated with GitHub, using [Jekyll] makes life easier when writing labs and assignments.
